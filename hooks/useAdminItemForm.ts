...
// Normalizes nested creator objects into flat arrays
...
export const useAdminItemForm = (initialData: any, itemId?: string, onComplete?: () => void) => {
  ...
  const handleClearForm = () => {
    setFormData({
      name: '', item_type: 'cup', collection_id: '', description: '', retail_price: '25', season: '', release_date: '', material: '',
  ...
  // Reads uploaded file and delegates parsing
  ...
  // Orchestrates database saves and relationship syncing
