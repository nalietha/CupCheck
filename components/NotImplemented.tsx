...
export default function NotImplemented({ featureName }: Props) {
  return (
    <div className="flex flex-col items-center justify-center min-h-[60vh] text-center p-8">
      ...
      <div className="text-6xl mb-6 animate-pulse text-pink-500">
        // 404
      </div>
      ...
      <Link 
        href="/" 
        className="px-8 py-3 bg-blue-600 hover:bg-blue-500 text-white font-bold rounded-sm transition-all shadow-[4px_4px_0px_0px_rgba(236,72,153,1)]"
      >
        Return to Safety
      </Link>
    </div>
